  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 bg-slate-50">
      <div className="w-full max-w-md bg-white rounded-3xl p-8 border border-slate-200 shadow-sm relative overflow-hidden">
        ...
        <div className="absolute -left-16 top-20 w-32 h-32 bg-blue-50 rounded-full blur-3xl opacity-50 pointer-events-none"></div>
        <div className="absolute -right-16 bottom-20 w-32 h-32 bg-blue-50 rounded-full blur-3xl opacity-50 pointer-events-none"></div>

        <div className="text-center mb-8 relative z-10">
          <h1 className="text-2xl font-bold text-slate-900 mb-2">
            Masuk <span className="text-slate-600 font-normal">ke KaryaSetara</span>
          </h1>
        ...
        <form className="space-y-5 relative z-10">
          ...
          <button type="submit" className="w-full bg-primary text-white font-semibold py-3.5 rounded-xl hover:bg-primary-hover transition-colors shadow-md shadow-blue-500/20">
            Masuk
          </button>
        </form>
        ...
        <div className="grid grid-cols-2 gap-3 relative z-10">
          <button className="flex items-center justify-center gap-2 border border-slate-200 rounded-xl py-2.5 hover:bg-slate-50 transition-colors text-sm font-medium text-slate-700">
        ...
        <p className="mt-8 text-center text-sm text-slate-600 relative z-10">
          Belum punya akun? <Link href="/register" className="text-primary hover:underline font-semibold">Daftar Sekarang</Link>
        </p>

        {/* Security badge at bottom left (absolute) like the ref */}
